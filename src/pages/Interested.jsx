        ...
        <div className="flex justify-center items-center min-h-screen p-4 lg:w-2/5 ">
            <div className="bg-white bg-opacity-90 backdrop-blur-md p-6 rounded-lg shadow-lg w-full max-w-md">
                ...
                <div className="mb-4 flex justify-center">
                    <Link to="dating_interest" className="w-full py-2 mb-2 bg-black text-white rounded-lg hover:bg-gray-500 text-center">Dating</Link>
                </div>
                <div className="mb-4 flex justify-center">
                    <Link to='' className="w-full py-2 bg-black text-white rounded-lg hover:bg-gray-500 text-center">Matrimony</Link>
                </div>
            </div>
        </div>
        </div>
