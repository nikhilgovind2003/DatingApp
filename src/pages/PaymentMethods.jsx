...
const PaymentMethods = () => {
  return (
    <div
      className="bg-white p-2 sm:p-3 lg:p-4 max-w-full sm:max-w-xs md:max-w-sm lg:max-w-md mx-auto rounded-lg shadow-md"
    ...
    >
      ...
      {/* Title */}
      <h1 className="text-xs sm:text-lg font-bold font-poppins text-purple-900 text-center sm:text-center">
        Payment methods
      </h1>
      <p className="text-gray-600 text-xs sm:text-md  mt-1 break-words line-clamp-2 mb-6 mt-3">
      ...
      <div className="mt-2 sm:mt-3 space-y-2 sm:space-y-3">
        <div className="border border-red-500 rounded-lg p-2 sm:p-3 flex items-center space-x-2 sm:space-x-3">
          ...
          <div className="flex-1">
            <p className="font-semibold text-xs sm:text-sm md:text-md sm:ms-7">************4444</p>
  ...
  <div className="flex-1">
    <p className="font-semibold text-xs sm:text-sm sm:ms-10">************3343</p>
    <p className="text-gray-500 text-xs sm:ms-10">Expires 09/25</p>
      ...
      <div className="mt-4 sm:mt-6">
        <p className="text-gray-700 font-semibold text-xs sm:text-sm">CURRENT METHOD</p>
  ...
  <img src="/IMAGES/fffff-removebg-preview 1.png" alt="Cash Payment" className="absolute inset-0 m-auto w-3/5 sm:w-4/5" />
          ...
          <div className="flex-1">
            <p className="font-semibold text-xs sm:text-sm sm:ms-11">Cash payment</p>
            <p className="text-gray-500 text-xs sm:ms-11">Default method</p>
          </div>
          <button
  aria-label="Expand"
  className="relative w-6 sm:w-8 text-sm sm:text-md font-bold text-gray-700"
>
  <img src="/IMAGES/Rectangle 68.png" alt="Background" className="w-full sm:w-6 ms-1 h-5" />
  <img src="/IMAGES/Vector.png" alt="Cash Payment" className="absolute inset-0 m-auto w-2/5 sm:w-4/4" />
</button>
      ...
      <button className="text-white w-full py-1 sm:py-2 mt-4 sm:mt-6 rounded-lg font-semibold text-xs sm:text-sm font-poppins" style={{backgroundColor:"#4b164c"}}>
  ADD PAYMENT METHOD
</button>

<img src="/IMAGES/Rectangle 67.png" alt="rectangle-shape" className="mt-4 sm:mt-6 mx-auto" />
